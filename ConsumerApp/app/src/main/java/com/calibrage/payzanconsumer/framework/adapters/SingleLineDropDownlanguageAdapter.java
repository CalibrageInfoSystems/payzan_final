...
public class SingleLineDropDownlanguageAdapter extends ArrayAdapter<String> {
    ...
    public SingleLineDropDownlanguageAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull ArrayList<String> data) {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charSequence != null) {
                    for (String data1 : data ) {
                        if (data1.toLowerCase().startsWith(charSequence.toString().toLowerCase())) {
                        }
                    }
